...
mongo_port =
mongo_database =
COMMENT_DATABASE_HOST = ENV.fetch('COMMENT_DATABASE_HOST')  { 'comment_db' }
COMMENT_DATABASE_PORT = ENV.fetch('COMMENT_DATABASE_PORT') { 27017 }
COMMENT_DATABASE = ENV.fetch('COMMENT_DATABASE')  { 'comments' }
